 ...
 */
export const PDA_SIMULATOR_MEASUREMENT_HEX =
 ...
 */
export const PDA_SIMULATOR_SIGNING_KEY_HEX =
  '5045505449444552582d53494d2d56312d5349474e2d4b455930310000000000';
 ...
 */
export const PDA_TEE_TYPES = ['sgx', 'nitro', 'h100_cc', 'oasis_rofl', 'simulator'] as const;

/** TEE backend identifier. V1 ships only the simulator. */
export type TeeType = (typeof PDA_TEE_TYPES)[number];
