 ...
 */
export async function pdaSha256(...chunks) {
 ...
 * helper.
 */
export async function pdaHmacSha256(key, message) {
    const subtle = getSubtle();
 ...
 */
export async function pdaComponentHash(domain, canonicalJsonBytes) {
 ...
 */
export function pdaTimingSafeEqual(a, b) {
 ...
 */
export function parseDigestHex(hex) {
...
function getSubtle() {
    ...
    if (!c || !c.subtle) {
        throw new Error('Web Crypto SubtleCrypto is not available. Node 20+ exposes it via ' +
